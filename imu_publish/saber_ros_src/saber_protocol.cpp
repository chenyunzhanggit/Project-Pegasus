...
void Saber_GetGNSSReceiverParaReq(signed char  nFD,u8* pData, u8 dataLen)
{
	sendPacket(nFD, MADDR_OUT, CLASS_ID_HOSTCONTROL_CMD, CMD_ID_GET_GNSS_PARA, 00, pData, dataLen);
}
