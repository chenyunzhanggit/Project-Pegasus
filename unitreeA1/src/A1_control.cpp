...
void UnitreeA1::linear_diff_timer_callback()
{
    ...
    //std::cout << "RUN_Pos0:    " << Leg1_UniA1.motor0_run.Pos << std::endl;
    ...
    //std::cout << "Cur_Pos0:    " << Leg1_UniA1.pos0_cur - Leg1_UniA1.pos0_init << std::endl;
    ...
    //std::cout << "RUN_Pos1:    " << Leg1_UniA1.motor1_run.Pos << std::endl;
    // encode data into motor commands
    ...
    //std::cout << "Cur_Pos1:    " << Leg1_UniA1.pos1_cur - Leg1_UniA1.pos1_init << std::endl;
    //std::cout << "Temp:   " << (int)motor_r.Temp << std::endl;
